# To become a maintainer of PalyrimOS
...
6 - Your device must be in accordance with the Device Requirements](https://github.com/PalyrimOS/official_devices/blob/master/docs/device_requirements.md)
